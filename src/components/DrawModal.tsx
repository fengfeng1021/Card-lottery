          ...
          >
            <div className="flex justify-between items-center mb-8 relative z-10">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-headline-md text-2xl text-white">{pool.title}</h3>
              </div>
            ...
            <div className="flex justify-center relative z-10 py-4">
              ...
              >
                <div className="absolute inset-0 bg-primary-fixed transform scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-300 ease-out z-0"></div>
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 shadow-[0_0_30px_rgba(0,255,255,0.8)] transition-opacity duration-300 pointer-events-none z-[-1]"></div>
              </button>
            </div>

            <div className="absolute bottom-[-50%] right-[-50%] w-full h-full bg-secondary-container/10 blur-[80px] rounded-full pointer-events-none"></div>
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
